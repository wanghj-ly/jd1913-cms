...
public class LinkServiceImpl implements ILinkService {
    ...
    @Override
    public void seveOrUpdateLink(Link link) throws CustomerException {
        if (link == null) {
    ...
    @Override
    public void deletelLink(int id) throws CustomerException {
        linkDao.deleteById(id);
    }

    @Override
    public Link quesryById(int id) throws CustomerException {
